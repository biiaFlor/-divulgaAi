...
const routes: Routes = [
  ...
  { path: 'company/:id', component: ShowCompanyComponent, resolve: { empresas: AllCompaniesResolver } },
  { path: 'product', component: CadProductComponent, resolve: { categorias: CategoriesResolver }, canActivate: [AuthGuard, CompanyGuard]  },
  { path: 'product/edit/:id', component: CadProductComponent, resolve: { categorias: CategoriesResolver }, canActivate: [AuthGuard, CompanyGuard]  },
